...
from utils import labels_names_correspondence
...
def Efficiencies_by_particles(params, eval_data, eval_proba_baseline, eval_proba, eval_labels, features, path="pic"):
...
def all_figures(params, eval_data, probs_dict, eval_labels, features, path="img"):
